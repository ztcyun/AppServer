...
const defaultExternal = ["stream", "react-dom/server","lodash/throttle","lodash/isEmpty","lodash/isEqual","lodash/differenceWith","lodash/uniqueId", ...deps.concat(peerDeps)];
